...
public class ClientImpl extends UnicastRemoteObject implements ClientCallback{
	...
	@Override
	public void registerCallback(boolean success, String uname) throws RemoteException {
		if(success)
			System.out.println("The user: " + uname + " is now registered");
		else
			System.out.println("The username is already taken. Try again with something else");
	}
	@Override
	public void loginCallback(boolean success, String uname) throws RemoteException {
		if(success)
