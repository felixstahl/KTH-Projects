 ...
 *
 *
 * good args inputs are "test", "6 7", "0 8 13".    The last 2 both have paths, but very long ones.
 * "1 2 13" is a short one
 *
 */
public class ShortestPath {
    ...
    private class Queue<Item extends Comparable<Item>> {
        ...
        // return true if(element1 is larger than element2), otherwise false
     ...
     *
     * OBS! CHANGE FILE FROM TEST TO NYX.TXT IF YOU WANT THE REAL FILE :)
     */
    ...
    private static void testPathTo() {
        ...
        assertTrue(pathTo2IsRight && pathTo3IsRight && pathTo5IsRight && pathTo6IsRight, "wrong path from 1-6");
    }
    ...
    private static void testDistTo() {
        ...
        assertTrue(distTo2IsRight && distTo7IsRight && distTo3IsRight, "incorrect calculations of distance between vertices");
    }
    ...
    private static void testHasPathTo() {
        ...
        assertTrue(path.hasPathTo(4), "vertex 1 should have a path to vertex 2");
        assertTrue(!path.hasPathTo(10), "vertex 1 should NOT have a path to vertex 10");
    }
    ...
    private static void testFindsShortestPath() {
        ...
        assertTrue(hasPathTo11, "Path should exist between 7 and 11");
        assertTrue(pathTo11.size() == 1, "Path between 7 and 11 should be of length 1");
        assertTrue(path.distTo[11] == 20, "Wrong distance between 7 and 11");
    }
    private static void testOwnInput(Scanner scan){
        ...
        if(detourTest.equals("x")) {
            ...
            if(mainRoute.hasPathTo(destinationTest)) {
    ...
    public static <U extends Consumer<String>> void readLinesFromFile(File file, U consumer) throws IOException {
        ...
        try {
            ...
            scanner.useDelimiter(" +"); // multiple whitespaces
